...
**Important — filenames.** The audio file is named after each module's internal id, and those
ids are **not** in tidy order. Use exactly these names:

| Lesson | Module | File |
|--------|--------|------|
| Two | Bubble Sort | `bubble-sort.mp3` |
| Two | Selection Sort | `selection-sort.mp3` |
| Two | Insertion Sort | `insertion-sort.mp3` |
| Two | Search | `search.mp3` |
| Two | The Race | `race.mp3` |
| Two | Challenge | `challenge-sorting.mp3` |
| Three | Stack | `stack.mp3` |
| Three | Queue | `queue.mp3` |
| Three | Breadth-First | `breadth-first.mp3` |
| Three | Depth-First | `depth-first.mp3` |
| Three | Challenge | `challenge-graphs.mp3` |

---

# Lesson Two — Sorting, Searching & Strategy

## Bubble Sort  ·  `bubble-sort.mp3`
...
## Selection Sort  ·  `selection-sort.mp3`
...
## Insertion Sort  ·  `insertion-sort.mp3`
...
## Challenge  ·  `challenge-sorting.mp3`
...
## Breadth-First  ·  `breadth-first.mp3`
...
## Challenge  ·  `challenge-graphs.mp3`
...
- Export MP3 (mono is fine), name by the table above (`bubble-sort`, `selection-sort`, … `challenge-graphs`), put them in `dojo-audio/` beside the app, commit, done.
